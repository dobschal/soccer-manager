export default {
  ...
  'dashboard.urgencyFreshness': '{count} Spieler in deiner Aufstellung haben niedrige Frische (unter 50%).',
  ...
  'tutorial.buildingsPage.item2': 'Das Fitnessstudio verbessert die Frische-Karten pro Spieltag',
