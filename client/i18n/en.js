export default {
  ...
  'landing.emailHint': 'We use your email only for password recovery. It is not shared with third parties.',
  ...
  'myTeam.prefixOnEmblem': 'Show "{prefix}" large on the emblem',
  'myTeam.prefix1OnBanner': 'Show "{prefix}" on the banner',
  'myTeam.prefix2OnBanner': 'Show "{prefix}" on the banner',
