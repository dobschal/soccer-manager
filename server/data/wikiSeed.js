...
• Freshness plus base level against in-game level for every player in your lineup – this shows whether your squad was fit enough to play the way you asked.
• Formation, attack mode, play style and pass style of both teams, so it can compare your setup with your opponent's.

Good to know:
• The report is created once per match and per language, then stored. Anyone opening that match afterwards sees it immediately.
• You can create up to 20 new reports per hour. Reading an existing one is always free.
• Forfeited and unplayed matches have no report, because there is no match data to analyse.
• The text is generated by an AI from the match statistics and can contain mistakes. The numbers themselves are calculated by the game, never by the AI.`
    },
    de: {
      title: 'Spielbericht',
...
• Frische sowie Grundstärke gegenüber In-Game-Stärke für jeden Spieler deiner Aufstellung – das zeigt, ob dein Kader fit genug war, um so zu spielen, wie du es verlangt hast.
• Formation, Angriffsmodus, Spielstil und Passstil beider Mannschaften, damit deine Aufstellung mit der des Gegners verglichen werden kann.

Gut zu wissen:
• Der Bericht wird pro Spiel und Sprache einmal erstellt und dann gespeichert. Wer die Partie danach öffnet, sieht ihn sofort.
• Du kannst bis zu 20 neue Berichte pro Stunde erstellen. Einen vorhandenen zu lesen ist immer kostenlos.
• Für abgesagte und noch nicht gespielte Partien gibt es keinen Bericht, weil dafür keine Spieldaten existieren.
• Der Text wird von einer KI aus den Spielstatistiken erzeugt und kann Fehler enthalten. Die Zahlen selbst berechnet immer das Spiel, nie die KI.`
    }
  },
