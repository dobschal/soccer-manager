...
- **TA-STD-34**: Beleuchtung der Szene: Ambient-Licht plus ein kuehles Mondlicht von oben und eine tief stehende, warme Abendsonne aus dem Westen (rund 15 Grad ueber dem Horizont). Die Sonne wirft bewusst keine Schatten - dafuer braeuchte sie eine Schattenkamera ueber die gesamte Bodenflaeche, und jeder Flutlichtmast bezahlt bereits einen eigenen Schattenpass. Ihre Staerke (`CONFIG.sun.intensity`) bleibt unter der der Flutlichter.
- **TA-STD-35**: Der Himmel ist eine Kuppel um die Szene, deren Vertexfarben aus `skyColor()` kommen: waagerecht ein Verlauf zwischen dem warmen Band in Sonnenrichtung und dem kuehlen Gegenhimmel, senkrecht von dort hoch ins Daemmerungsviolett. Die Kuppel liegt ausserhalb des Nebels (sonst wuerde er sie zu einer Flaeche verflachen) und schreibt keine Tiefe, steht also hinter allem anderen.
