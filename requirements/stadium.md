...
- **TA-STD-44a**: Die Tafel wird in die Luecke zwischen Eingangsdach und Oberkante der Rueckwand eingepasst (maximal 2,4 Einheiten); ist dort weniger als 1 Einheit Platz, bekommt die Tribuene kein Schild. Das Wappen ist dasselbe SVG wie ueberall sonst (`renderEmblem`), ueber `emblemPlateTexture` in ein Canvas gerastert - **eine** Textur fuer alle Eingaenge, nicht eine pro Eingang. Ohne 2D-Kontext entfaellt das Schild samt Lampen.
