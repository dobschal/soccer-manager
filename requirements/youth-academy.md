...
- **US-YA-03**: Als Spieler erhalte ich abhängig vom Akademie-Level unterschiedlich viele Jugendspieler-Karten pro Saison (~2 / 3 / 4 für Level 1 / 2 / 3).
...
|---|---|---|---|
| 1 (Basis, Startlevel) | – | – | ~2x NEW_YOUTH_PLAYER_1 |
...
- Karten-Wahrscheinlichkeiten je Akademie-Level (Summe pro Saison ~2/3/4 für Level 1/2/3)
