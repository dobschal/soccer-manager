...
- **TA-BLD-22b**: Der Eingang liegt gross in der Glashalle, darueber prangt das Vereinsemblem (dieselbe Wappen-Textur wie an den Stadion-Eingaengen, `emblemPlateTexture`). Alles ist innen beleuchtet: die Halle hat eine leuchtende Deckenflaeche plus ein Punktlicht, die Fenster der Seitenfluegel leuchten warm.
